...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown" style="display: none;" id="userDropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="user-avatar"><?= substr($_SESSION["name"], 0, 1) ?></span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.altKey && e.key === 'h') {
                e.preventDefault();
                window.location.href = 'index.php'; // Consider using baseUrlForJs here too
            }

            // Alt + A for Assets
            if (e.altKey && e.key === 'a') {
                e.preventDefault();
                window.location.href = 'assets/list.php'; // Consider using baseUrlForJs here too
            }
            ...
            if (e.altKey && e.key === 'l') {
                ...
                if (confirm('คุณต้องการออกจากระบบหรือไม่?')) {
                    window.location.href = `${baseUrlForJs}logout.php`; // Updated this as well
                }
            }
        });
    });
